...
const file_auth_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"auth.proto\x12\x04auth\x1a\x17validate/validate.proto\"X\n" +
	"\fLoginRequest\x12#\n" +
	...
	"\vAuthService\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponseB.Z,github.com/eamanzholov/middleware_auth;protob\x06proto3"
